        ...
        <div class="login-form">
            ...
            <form action="{{ url('login-post') }}" method="POST">
                ...
                <div class="form-field mb-3">
                    ...
                    <!-- <input type="password" name="password" /> -->
                    <a href="{{url('/forgot-password')}}" class="pt-3">Forgot Password?</a>
                    <a href="{{ url('user-signup') }}" class="d-flex flex-sm-row flex-column justify-content-end">Don’t have an account? <span style="color: rgb(98, 98, 197)" class="pl-2">Sign Up</span></a>
                </div>
